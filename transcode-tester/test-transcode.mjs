 ...
 *
 * Environment:
 *   TRANSCODE_BASE_URL - runner base URL (default: http://localhost:8086)
...
const baseURL = process.env.TRANSCODE_BASE_URL || "http://localhost:8086";
const submitEndpoint = `${baseURL}/v1/video/transcode`;
const statusEndpoint = `${baseURL}/v1/video/transcode/status`;
const presetsEndpoint = `${baseURL}/v1/video/transcode/presets`;
